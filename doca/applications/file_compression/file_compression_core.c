 ...
 * @return: DOCA_SUCCESS on success and DOCA_ERROR otherwise
 */
static doca_error_t init_compress_resources(struct file_compression_config *app_cfg,
 ...
 * @return: DOCA_SUCCESS on success and DOCA_ERROR otherwise
 */
static doca_error_t set_endpoint_properties(enum file_compression_mode mode,
 ...
 * @return: DOCA_SUCCESS on success and DOCA_ERROR otherwise
 */
static doca_error_t send_file(struct doca_comm_channel_ep_t *ep,
				     ...
				     enum file_compression_compress_method method)
{
	...
	result = compress_file(compressed_file,
			       tmp_compressed_file - compressed_file,
			       max_buf_size,
			       resources,
			       method,
...
void file_compression_cleanup(struct file_compression_config *app_cfg,
			      struct doca_comm_channel_ep_t *ep,
