...
struct decrypt_pipes {
	...
	struct security_gateway_pipe_info decap_ipv4_pipe;	  /* decap ESP header pipe for ipv4 packets */
	struct security_gateway_pipe_info decap_ipv6_pipe;	  /* decap ESP header pipe for ipv6 packets */
	struct security_gateway_pipe_info bad_syndrome_ipv4_pipe; /* match on ipsec bad syndrome for ipv4 packets */
	struct security_gateway_pipe_info bad_syndrome_ipv6_pipe; /* match on ipsec bad syndrome for ipv6 packets */
};
