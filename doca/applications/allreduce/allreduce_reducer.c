 ...
 */
static inline void summation(void *dst_vector, void *src_vector, size_t length, enum allreduce_datatype datatype)
{
	size_t i;
 ...
 * @datatype [in]: Identify the type of the vectors elements
 */
static inline void product(void *dst_vector, void *src_vector, size_t length, enum allreduce_datatype datatype)
{
	size_t i;
