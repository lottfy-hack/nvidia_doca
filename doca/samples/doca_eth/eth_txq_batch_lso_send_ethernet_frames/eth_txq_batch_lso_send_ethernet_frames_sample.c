...
struct eth_txq_batch_lso_send_sample_objects {
	...
	struct doca_gather_list *lso_pkt_headers[GATHER_LISTS_NUM]; /* DOCA gaher lists array to contain LSO packet
								       headers */
 ...
 * succesfull CB, all are DOCA_SUCCESS)
 */
...
/*
 * Creaet DOCA gather_lists for the packet headers
 *
