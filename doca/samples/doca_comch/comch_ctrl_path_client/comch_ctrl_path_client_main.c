...
/* Sample's Logic */
doca_error_t start_comch_ctrl_path_client_sample(const char *server_name, const char *dev_pci_addr, const char *text);
...
int main(int argc, char **argv)
{
	...
	/* Start the client */
	result = start_comch_ctrl_path_client_sample(server_name, cfg.comch_dev_pci_addr, cfg.text);
	if (result != DOCA_SUCCESS) {
