 ...
 */
__dpa_global__ void binary_tree_kernel(struct binary_tree_kernel_args kernel_args)
{
	...
	if (kernel_args.wait_event)
		doca_dpa_dev_sync_event_wait_gt(kernel_args.wait_event,
						kernel_args.wait_thresh - 1,
						SYNC_EVENT_MASK_FFS);
